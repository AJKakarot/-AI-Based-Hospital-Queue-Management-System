...
export async function checkAndAllocateCredits(user) {
  try {
    ...
    // Do not call revalidatePath here — this function runs during layout/page
    // render (e.g. from Header), and revalidatePath during render is not allowed.
    // Credit balance is updated in DB; pages will show fresh data on next request.
