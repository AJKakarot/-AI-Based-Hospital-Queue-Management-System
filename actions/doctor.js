...
export async function cancelAppointment(formData) {
  ...
  try {
    ...
    await db.$transaction(async (tx) => {
      ...
      // Refund credits ONLY if cancelled before the appointment start time.
      // If patient/doctor cancels after the slot has started (e.g. during or after
      // the video call), no refund — doctor keeps the credits for work done.
    ...
    return { success: true, refunded: cancelledBeforeStart };
  } catch (error) {
